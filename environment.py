...
class DoublePendulumEnv(gym.Env):
    ...
    def __init__(self, reward_type='shaped', render_mode: Optional[str] = None):
        super().__init__()
        ...
        # Bodies stored for cleanup
        self.cart_body: Any = None
        self.pole1_body: Any = None
        self.pole2_body: Any = None
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        self.groove = pymunk.GrooveJoint(
            self.space.static_body, self.cart_body, (50, 300), (750, 300), (0, 0)
        )
        ...
        self.space.add(
            self.track, self.cart_body, self.cart_shape, self.groove,
    ...
    def step(self, action):
        force_mag = float(action[0]) * 5000.0  # Scale action [-1, 1] to force
    ...
    def render(self):
        ...
        def flipy(y):
            return self.screen_height - int(y)

        # Draw track
        pygame.draw.line(self.screen, (0, 0, 0), (50, flipy(300)), (750, flipy(300)), 5)

        # Draw cart
        cx = int(self.cart_body.position.x)
        cy = flipy(self.cart_body.position.y)
        ...
        p1_end = (
            int(p1_start[0] - 100 * math.sin(self.pole1_body.angle)),
        ...
        p2_start = p1_end
        p2_end = (
            int(p2_start[0] - 100 * math.sin(self.pole2_body.angle)),
